...
public class SIPRequestsTests {
  ...
  public void testRegisterParse() throws SIPProtocolException {
    ...
    assertEquals("1 REGISTER", srm.getFullCSeq());
    assertEquals(1L, srm.getCSeqNumber());
    assertEquals("LittleGuy <sip:UserB@there.com>", srm.getFullTo());
    assertEquals("LittleGuy1 <sip:UserB1@there.com>", srm.getFullFrom());
    assertEquals("UserB1@there.com", srm.getFromURI());
    assertEquals("UserB@there.com", srm.getToURI());
    assertEquals("UserB", srm.getToUser());
    assertEquals("UserB1", srm.getFromUser());
    assertEquals("there.com", srm.getFromHost());
    assertEquals("there.com", srm.getToHost());
  ...
  public void testRegisterParse2() throws SIPProtocolException {
    ...
    assertEquals("123456789@there.com", srm.getCallId());
    assertEquals(2, srm.getCSeqNumber());
    assertEquals("LittleGuy <sip:UserB@there.com>", srm.getFullTo());
    assertEquals("LittleGuy1 <sip:UserB1@there.com>", srm.getFullFrom());
    assertEquals(0, srm.getContentLength());
  ...
  public void testInviteParse() throws SIPProtocolException {
    ...
    assertEquals(1, srm.getCSeqNumber());
    assertEquals("LittleGuy <sip:UserB@there.com>", srm.getFullTo());
    assertEquals("BigGuy <sip:UserA@here.com>", srm.getFullFrom());
